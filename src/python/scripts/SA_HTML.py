...
def plot_sentiment_trends_with_predictions(df, country):
    ...
    # Add traces for predicted sentiment as a dashed line
    fig.add_trace(go.Scatter(x=predicted_years, 
...
for country in countries:
    fig = plot_sentiment_trends_with_predictions(df, country)
    file_path = os.path.join(os.path.dirname(__file__), f'../data/{country}_sentiment_trends.html')
